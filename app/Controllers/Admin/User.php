...
class User extends BaseController
{
    ...
    public function index()
    {
        ...
        return view($this::$pagesAdmin . 'v_user_index', $data);
    }


    public function data($id = '')
    {
        $admin = (new AdminModel())->find($id);
    ...
    public function delete($id)
    {
        ...
        if ($data) {
            ...
            if ($id != session('_ci_admin_login.id')) {
                (new AdminModel())->delete($id);
                $message = pesan('success', 'Data deleted successfully!');
            } else {
                $message = pesan('warning', "you can't delete yourself!");
            }
        }
